...
Aus Plant Phenology is an interactive data visualization tool that allows researchers, conservationists, and plant enthusiasts to explore flowering and seeding patterns of Australian native plants.

The application provides filtering capabilities, visual charts, and species data management to support conservation planning and ecological research.
...
3. Load your first dataset:
   ...
   * Use the dataset selector dropdown
   * Click **"Load"**
...
Core theme colours can be customized in `style.css`:
...
| Issue                        | Solution                                                            |
| ---------------------------- | ------------------------------------------------------------------- |
| **Charts don't load**        | Check browser console for errors, ensure dataset is properly loaded |
| **Charts don't load**        | Verify CSV format matches required columns                          |
| **Filters not applying**     | Ensure dataset is loaded (check species count)                      |
| **Filters not applying**     | Check for JavaScript errors in console                              |
| **Theme toggle not working** | Clear browser cache and reload                                      |
| **Theme toggle not working** | Ensure app.js loads after DOM content                               |
| **Data not exporting**       | Check browser permissions for file downloads                        |
| **Data not exporting**       | Try different browser                                               |
